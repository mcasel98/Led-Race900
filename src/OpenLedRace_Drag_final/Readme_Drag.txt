...
- Fully non-blocking game logic: the race simulation never pauses!
- Podium lights, winner music, and finish flag show
- Automatic return of cars to the starting line before each new race
- **New DRAG EFFECT:**  
    When the car’s speed exceeds a threshold (`2.0`),  
    the leader shows a glowing drag effect (4 consecutive leds: body+tail+2 fading); the second place car has 3.  
    This simulates the F1 racing “drag” for maximum visual flair!

**3D printable STL files:**
In the `/stl` folder you’ll find enclosures and button mounts:
- **Button_Case_Base.stl** : button holder base
- **LedRace900-Corpo.stl** : printable enclosure/body for controller

**Credit where due:**
- Original project: G. Barbarov ([OpenLedRace repo](https://github.com/gbarbarov/led-race))
