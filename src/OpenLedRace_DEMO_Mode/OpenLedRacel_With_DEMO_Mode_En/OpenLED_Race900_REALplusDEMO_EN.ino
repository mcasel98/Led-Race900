 ...
 * ____                      _      ______ _____    _____
 ...
 Real mode + random DEMO, demo acceleration x2, demo entry messages in 3 steps.
 Definitive version January 2026 - mcasel98 & GitHub Copilot

 * ==============================================================
 *  OpenLED Race 900 - REAL plus DEMO
 *  Final Version - January 2026
 *  Authors: Marcello Caselli (mcasel98) & GitHub Copilot
 *
 *  Open Source Slot Car LED Track Project
 *  Dual mode: real (hardware) and demo (random virtual)
 *  Demo acceleration x2. Demo entry messages in 3 steps.
 *  Hardware compatible: Adafruit NeoPixel, MD_MAX72xx LED Matrix
 *  Compatible with Arduino IDE 1.x/2.x
 *
