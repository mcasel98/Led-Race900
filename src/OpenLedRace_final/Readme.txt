...
- **Anti-rimbalzo**: Routine debounce robusta per evitare false attivazioni
...
- Fullly non-blocking logic: race simulation never pauses!
...
**DEMO Mode:**
- **Entry**: Hold START button for at least 3 seconds from main menu
...
- **Debounce**: Robust anti-bounce routine to prevent false triggers
